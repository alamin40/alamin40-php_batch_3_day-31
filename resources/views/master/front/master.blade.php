...
<body>
    <nav class="navbar navbar-expand-md navbar-light bg-lb shadow sticky-top">
        <div class="container">
            <a href="" class="navbar-brand fw-bolder">LOGO</a>
            <ul class="navbar-nav">
                <li><a href="{{route('home')}}" class="nav-link">Home</a></li>
                <li><a href="" class="nav-link">All Course</a></li>
                <li><a href="{{route('user-login')}}" class="nav-link">Login</a></li>
                <li><a href="{{route('user-register')}}" class="nav-link">Register</a></li>
            </ul>
        </div>
    </nav>
    ...
    <footer class="pt-4 pb-5 bg-dark">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <div class="card card-body rounded-0 h-200">
                        <h3>About Institute</h3>
                        <hr/>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias eos incidunt placeat quidem tempore veritatis!</p>
                ...
                <div class="col-sm-4">
                    <div class="card card-body rounded-0 h-200">
                        ...
                        <hr/>
                        <ul>
                            <li><a href="">Popular class one</a></li>
                            <li><a href="">Popular class two</a></li>
                            <li><a href="">Popular class three</a></li>
                        </ul>
                ...
                <div class="col-sm-4">
                    <div class="card card-body rounded-0 h-200">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="" class="nav-link"><i class="fab fa-2x fa-git-square"></i></a></li>
