                            ...
                            @foreach($subjects as $subject)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="row">
                                            <a href="{{route('edit-teacher', ['id' => $subject->id])}}" class="btn btn-success btn-sm col-md-3 mx-auto">
                                                <i class="fa fa-edit "></i>
                                            </a>

                                            <a href="{{route('delete-teacher', ['id' => $subject->id])}}" class="btn btn-danger btn-sm col-md-3 mx-auto">
